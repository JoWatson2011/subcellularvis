...
saveRDS(traffic_annots, "data/Xenopus/traffic_annots.rds")
...
saveRDS(annots, "data/Xenopus/annots.rds")
...
saveRDS(traffic_subannots_genes, "data/Xenopus/traffic_subAnnots.rds")
...
saveRDS(subannots_genes, "data/Xenopus/subAnnots.rds")
